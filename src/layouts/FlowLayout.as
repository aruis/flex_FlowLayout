...
public class FlowLayout extends LayoutBase {
    ...
    override public function measure():void {
        ...
        var element:ILayoutElement = useVirtualLayout ?
                layoutTarget.getVirtualElementAt(count - 1) :
                layoutTarget.getElementAt(count - 1);

        layoutTarget.measuredHeight = element.getLayoutBoundsY() + element.getLayoutBoundsHeight() + _border;
